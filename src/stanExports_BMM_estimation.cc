...
#include "stanExports_BMM_estimation.h"

RCPP_MODULE(stan_fit4BMM_estimation_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_BMM_estimation")
